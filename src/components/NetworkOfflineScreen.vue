...
<div class="container d-flex w-100 h-100 p-3 mx-auto flex-column justify-content-center d-flex">
  ...
  <div class="mt-1">
    <h1 class="text-center ps-3 pe-3 mb-4">
    ...
    <p class="text-center ps-3 pe-3">
      Your device is disconnected from the internet. Please connect to the internet and reload to use this app.
    </p>
  </div>

  <div class="d-flex justify-content-center mt-1">
    <button class="btn btn-secondary btn-lg mt-3 btn-install" @click="reloadPage">
      Reload
    </button>
  </div>
